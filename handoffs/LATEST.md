# GHMD Sales Platform — Handoff v2.30

Date: 2026-07-06 | Prepared by: Chat | Purpose: Post-v3-sizing-engine-merge bump — supersedes v2.29.

Main has moved from `36b7c7f` to `be36525` (PR #75 merged) and the decision log has moved from tip #86 to tip #90 since v2.29.
...
| Decision log tip | **#90** (see below for full sequence since v2.29) |
| Decision mirror | `/decisions/DECISION_LOG.md` — **STALE, behind #78**; regen still blocked (see Deferred) |

## Decision sequence since v2.29 (tip #86 → #90)
